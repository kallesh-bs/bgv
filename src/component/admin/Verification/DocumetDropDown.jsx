...
const DocumetDropDown = () => {
   ...
   const {userData, tabName} = useSelector((reducer)=> reducer.VerificationReducer)
   const [isLoading , setIsLoading]=useState(false)
   const dispatch = useDispatch()

   function sendConsetNotify(params) {
       return dispatch(sendNotify(userData?.userData?.id , setIsLoading , setNotifyPopUp))
   }
