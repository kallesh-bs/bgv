...
describe("Forgot Component", () => {
  ...
  it('renders learn react link', () => {
    ...
    render(
      ...
      let RightArraowHandleDropDownbtn = screen.getByTestId("RightArraowHandleDropDown") as HTMLDivElement ;
      fireEvent.click(RightArraowHandleDropDownbtn)
      const leftArraowHandleDropDownbtn = screen.getByTestId("leftArraowHandleDropDown") as HTMLDivElement ;
      fireEvent.click(leftArraowHandleDropDownbtn)
      RightArraowHandleDropDownbtn = screen.getByTestId("RightArraowHandleDropDown") as HTMLDivElement ;
      fireEvent.click(RightArraowHandleDropDownbtn)
