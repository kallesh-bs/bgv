...
describe("EducationCheck Component", () => {
    let store: any;

    const empDataById = { id: 3};
    const item1 = { name: 'sample1.pdf', url: 'https://deeporiondemo.s3.ap-south-1.amazonaws.com/mt35r3sn2ooj3qnqps70oc2g9rh21' };
    const item2 = { name: 'sample2.pdf', url: 'https://deeporiondemo.s3.ap-south-1.amazonaws.com/mt35r3sn2ooj3qnqps70oc2g9rh22' };
    const item3 = { name: 'sample3.pdf', url: 'https://deeporiondemo.s3.ap-south-1.amazonaws.com/mt35r3sn2ooj3qnqps70oc2g9rh23' };
    const item4 = { name: 'sample4.pdf', url: 'https://deeporiondemo.s3.ap-south-1.amazonaws.com/mt35r3sn2ooj3qnqps70oc2g9rh24' };
  ...
  it('renders with documents :', () => {
    ...
    render(
      ...
      let deleteFilebtn1 = screen.getByTestId(`deleteFilebtn${item1.url}`) as HTMLDivElement ;
      ...
      deleteFilebtn1 = screen.getByTestId(`deleteFilebtn${item2.url}`) as HTMLDivElement ;
      fireEvent.click(deleteFilebtn1)
      handleFileDelete(
        empDataById.id,
        item2.url,
      ...
      deleteFilebtn1 = screen.getByTestId(`deleteFilebtn${item3.url}`) as HTMLDivElement ;
      fireEvent.click(deleteFilebtn1)
      handleFileDelete(
        empDataById.id,
        item3.url,
