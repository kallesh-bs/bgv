...
describe("ExtraActions Component : ", () => {
  ...
  it('renders with no documents with Tab 1', () => {
    ...
    render(
          <I18nextProvider i18n={i18n}>
              <Provider store={store}> 
                  <ExtraActions nodata={true} doc_status_column={VerificationDataKey.IDENTITY_CHECK_DOCUMENTS_STATUS} doc_column={VerificationDataKey.IDENTITY_CHECK_DOCUMENTS} />
              </Provider>
          </I18nextProvider>
      );
  });
  ...
  it('renders with no documents with Tab 2', () => {
    ...
    render(
          <I18nextProvider i18n={i18n}>
              <Provider store={store}> 
                  <ExtraActions nodata={true} doc_status_column={VerificationDataKey.ADDRESS_CHECK_DOUCMENTS_STATUS} doc_column={VerificationDataKey.ADDRESS_CHECK_DOUCMENTS} />
              </Provider>
          </I18nextProvider>
      );
  });
  ...
  it('calls handleUpdateStatus on click', () => {
    ...
    const { getByText } = render(
      <I18nextProvider i18n={i18n}>
          <Provider store={store}> 
              <ExtraActions nodata={false} doc_status_column={VerificationDataKey.ADDRESS_CHECK_DOUCMENTS_STATUS} doc_column={VerificationDataKey.ADDRESS_CHECK_DOUCMENTS} />
          </Provider>
      </I18nextProvider>
  );
    
    // expect(handleUploadFile).toHaveBeenCalledTimes(1);
    const extraActionPopUpbtn = screen.getByTestId("extraActionPopUpbtn") as HTMLDivElement ;
