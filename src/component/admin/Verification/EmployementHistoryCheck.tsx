        ...
        <div className="w-[100%] h-[55px] flex">
          <div className="xl:w-[100%] lg:w-[100%] md:w-[100%] text-2xl flex justify-between items-center font-medium text-base">
            ...
            {data1 ? 
              ...
              : 
                <ExtraActions doc_status_column={VerificationDataKey.RELIEVING_LETTERS_STATUS} doc_column={VerificationDataKey.RELIEVING_LETTERS} nodata={true} />
            }
          </div>
        </div>
        <div>
          {data1 ? 
              ...
              <div className="w-full flex items-center justify-between border p-[10px_14px_10px_10px] mt-3">
                {item.name}
                <RxCross2 onClick={() => handleFileDelete(empDataById.id, item.url,VerificationDataKey.RELIEVING_LETTERS, dispatch)} className="cursor-pointer" />
              </div>) 
            : 
        ...
        <div className="w-[100%] h-[55px] flex">
          <div className="xl:w-[100%] lg:w-[100%] md:w-[100%] text-2xl flex justify-between items-center font-medium text-base">
            ...
            {data2 ? 
              ...
              : 
                <ExtraActions nodata={true} doc_status_column={VerificationDataKey.EXPERIENCE_LETTERS_STATUS} doc_column={VerificationDataKey.EXPERIENCE_LETTERS} />
            }
          </div>
        </div>
        <div>
          {data2 ? 
              ...
              <div className="w-full flex items-center justify-between border p-[10px_14px_10px_10px] mt-3">
                {item.name}
                <RxCross2 onClick={() => handleFileDelete(empDataById.id, item.url, VerificationDataKey.EXPERIENCE_LETTERS, dispatch)} className="cursor-pointer" />
              </div>) 
            : 
              <div className="w-full flex items-center justify-between border p-[10px_14px_10px_10px] mt-3">{'No data'}</div>
          }
        ...
        <div className="w-[100%] h-[55px] flex">
          <div className="xl:w-[100%] lg:w-[100%] md:w-[100%] text-2xl flex justify-between items-center font-medium text-base">
            ...
            {data3 ? 
              ...
              : 
                <ExtraActions doc_status_column={VerificationDataKey.BANK_STATEMENTS_STATUS} doc_column={VerificationDataKey.BANK_STATEMENTS} nodata={true} />
            }
          </div>
        </div>
        <div>
          {data3 ? 
              ...
              <div className="w-full flex items-center justify-between border p-[10px_14px_10px_10px] mt-3">
                {item.name}
                <RxCross2 onClick={() => handleFileDelete(empDataById.id, item.url,VerificationDataKey.BANK_STATEMENTS, dispatch)} className="cursor-pointer" />
              </div>) 
            : 
              <div className="w-full flex items-center justify-between border p-[10px_14px_10px_10px] mt-3">{'No data'}</div>
          }
